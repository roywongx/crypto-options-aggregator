...
PANEL_CONFIGS: Dict[str, Dict[str, Any]] = {
    "test_panel": {
        "name": "测试面板",
        "rules": [
            {"id": "r1", "name": "规则1", "fn": lambda d, c: RuleResult(name="规则1", score=75, verdict="好", reasoning=["t1"]), "weight": 0.6},
            {"id": "r2", "name": "规则2", "fn": lambda d, c: RuleResult(name="规则2", score=55, verdict="中", reasoning=["t2"]), "weight": 0.4},
        ],
    ...
    "risk_test_panel": {
        "name": "风险测试面板",
        "rules": [
            {"id": "r1", "name": "风险1", "fn": lambda d, c: RuleResult(name="风险1", score=25, verdict="高风险", reasoning=["r1"]), "weight": 1.0},
        ],

...
def main() -> int:
    ...
    sell_put_parser = subparsers.add_parser("recommend", help="Get option recommendations")
    ...
    sell_put_parser.add_argument("--strike", type=float)
    sell_put_parser.add_argument("--strike-range")
    sell_put_parser.add_argument("--margin-ratio", type=float, default=0.2)
    sell_put_parser.add_argument("--option-type", type=str, default="PUT", choices=["PUT", "CALL"])
    ...
    scan_parser.add_argument("--strike", type=float)
    scan_parser.add_argument("--strike-range")
    scan_parser.add_argument("--margin-ratio", type=float, default=0.2)
    ...
    report_parser.add_argument("--strike", type=float)
    report_parser.add_argument("--strike-range")
    report_parser.add_argument("--margin-ratio", type=float, default=0.2)
    ...
    if args.command == "doctor":
        ...
        result = monitor.get_options_recommendations(
            currency=args.currency,

    ...
    try:
        ...
        for s in r_info['optionSymbols']:
            if s['underlying'] == underlying and s['side'] == target_side and s['expiryDate'] > now:
                # 1. Basic Filters: DTE and Strike
                ...
                # 3. Liquidity Data (Spread & Volume)
        ...
        # Sort by Liquidity Score then APR descending
